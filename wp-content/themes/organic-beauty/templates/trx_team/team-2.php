...
if ( !function_exists( 'organic_beauty_template_team_2_theme_setup' ) ) {
	add_action( 'organic_beauty_action_before_init_theme', 'organic_beauty_template_team_2_theme_setup', 1 );
	function organic_beauty_template_team_2_theme_setup() {
		organic_beauty_add_template(array(
			'layout' => 'team-2',
			'template' => 'team-2',
			'mode'   => 'team',
			'title'  => esc_html__('Team /Style 2/', 'organic-beauty'),
...
// Template output
if ( !function_exists( 'organic_beauty_template_team_2_output' ) ) {
	function organic_beauty_template_team_2_output($post_options, $post_data) {
		$show_title = true;
		...
		?>
			...
			><div class="sc_team_item_avatar column-2_5">
					<?php organic_beauty_show_layout($post_options['photo']); ?>
