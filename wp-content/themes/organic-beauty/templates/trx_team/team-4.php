...
if ( !function_exists( 'organic_beauty_template_team_4_theme_setup' ) ) {
	add_action( 'organic_beauty_action_before_init_theme', 'organic_beauty_template_team_4_theme_setup', 1 );
	function organic_beauty_template_team_4_theme_setup() {
		organic_beauty_add_template(array(
			'layout' => 'team-4',
			'template' => 'team-4',
			'mode'   => 'team',
			'title'  => esc_html__('Team /Style 4/', 'organic-beauty'),
...
// Template output
if ( !function_exists( 'organic_beauty_template_team_4_output' ) ) {
	function organic_beauty_template_team_4_output($post_options, $post_data) {
		$show_title = true;
