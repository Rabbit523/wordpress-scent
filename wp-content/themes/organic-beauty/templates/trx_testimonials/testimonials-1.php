...
if ( !function_exists( 'organic_beauty_template_testimonials_1_theme_setup' ) ) {
	add_action( 'organic_beauty_action_before_init_theme', 'organic_beauty_template_testimonials_1_theme_setup', 1 );
	function organic_beauty_template_testimonials_1_theme_setup() {
		organic_beauty_add_template(array(
			'layout' => 'testimonials-1',
			'template' => 'testimonials-1',
			'mode'   => 'testimonials',
			'title'  => esc_html__('Testimonials /Style 1/', 'organic-beauty'),
...
// Template output
if ( !function_exists( 'organic_beauty_template_testimonials_1_output' ) ) {
	function organic_beauty_template_testimonials_1_output($post_options, $post_data) {
		$show_title = true;
