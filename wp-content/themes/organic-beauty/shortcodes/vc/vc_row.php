...
if (function_exists('vc_map_get_attributes')) {						// New VC
	 ...
	 * @var $scheme		- added by Organic Beauty
	 * @var $inverse	- added by Organic Beauty
	 * @var $atts
	 * @var $el_class
	 * @var $full_width
	 * @var $full_height
	...
	// Added by Organic Beauty:
	// Color scheme
	if ($scheme && !organic_beauty_param_is_off($scheme) && !organic_beauty_param_is_inherit($scheme)) $css_classes[] = 'scheme_'.esc_attr($scheme);
	// Inverse colors
	if ($inverse && !organic_beauty_param_is_off($inverse)) $css_classes[] = 'inverse_colors';
	...
	// Add Organic Beauty color scheme in the row
	if ($scheme && !organic_beauty_param_is_off($scheme) && !organic_beauty_param_is_inherit($scheme)) $css_class .= ' scheme_'.esc_attr($scheme);
	...
	} ?> <?php organic_beauty_show_layout($style); ?>><?php
	echo wpb_js_remove_wpautop( $content );
	?></div><?php organic_beauty_show_layout($this->endBlockComment('row'));
	if ( ! empty( $full_width ) ) {
