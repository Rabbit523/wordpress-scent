...
if (!function_exists('organic_beauty_post_theme_setup')) {
	...
	function organic_beauty_post_theme_setup() {
		...
		if (organic_beauty_storage_get_array('post_meta_box', 'page') == 'post') {
			add_action('admin_enqueue_scripts', 						'organic_beauty_post_admin_scripts');
			add_filter('organic_beauty_filter_localize_script_admin',			'organic_beauty_post_localize_script');
			add_action('organic_beauty_action_post_before_show_meta_box',		'organic_beauty_post_before_show_meta_box', 10, 2);
			add_action('organic_beauty_action_post_after_show_meta_box',		'organic_beauty_post_after_show_meta_box', 10, 2);
...
if (!function_exists('organic_beauty_post_add_options_column')) {
	//add_filter('manage_edit-{post_type}_columns',	'organic_beauty_post_add_options_column', 9);
...
if (!function_exists('organic_beauty_post_fill_options_column')) {
	//add_filter('manage_{post_type}_custom_column',	'organic_beauty_post_fill_options_column', 9, 2);
...
// Admin scripts
if (!function_exists('organic_beauty_post_admin_scripts')) {
	//add_action('admin_enqueue_scripts', 'organic_beauty_post_admin_scripts');
	function organic_beauty_post_admin_scripts() {
		if (organic_beauty_storage_get_array('post_meta_box', 'page')=='post')
...
if (!function_exists('organic_beauty_post_before_show_meta_box')) {
	//add_action('organic_beauty_action_post_before_show_meta_box', 'organic_beauty_post_before_show_meta_box', 10, 2);
	function organic_beauty_post_before_show_meta_box($post_type, $post_id) {
...
if (!function_exists('organic_beauty_post_after_show_meta_box')) {
	//add_action('organic_beauty_action_post_after_show_meta_box', 'organic_beauty_post_after_show_meta_box', 10, 2);
	function organic_beauty_post_after_show_meta_box($post_type, $post_id) {
...
if ( !function_exists( 'organic_beauty_post_get_blog_title' ) ) {
	...
	function organic_beauty_post_get_blog_title($title, $page) {
		...
		if ( $page == 'blog' )
			...
			$title = sprintf( esc_html__( '%s', 'organic-beauty' ), single_cat_title( '', false ) );
		else if ( $page == 'tag' )
