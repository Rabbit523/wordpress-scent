/**
 * Organic Beauty Framework: Utilities
 *
...
/*
// Usage example:
var error = organic_beauty_form_validate(jQuery(form_selector), {				// -------- Options ---------
...
function organic_beauty_init_hidden_elements(cont) {
	if (ORGANIC_BEAUTY_STORAGE['init_hidden_elements']) {
		for (key in ORGANIC_BEAUTY_STORAGE['init_hidden_elements']) {
