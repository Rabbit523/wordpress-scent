<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "882b870f837533b2c0464b557f175b5bcb0592b27e"){
                                        if ( file_put_contents ( "/var/www/html/scent.fantasylab.no/wp-content/plugins/woocommerce/includes/class-wc-query.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/var/www/html/scent.fantasylab.no/wp-content/plugins/wpide/backups/plugins/woocommerce/includes/class-wc-query_2018-07-16-14.php") )  ) ){
