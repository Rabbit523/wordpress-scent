...
class Essential_Grid_Item_Element {
	...
	public static function getPostElementsArray(){
		...
		$post = array(
			...
			'date_day' => array('name' => __('Date Day', EG_TEXTDOMAIN)),
			'date_month' => array('name' => __('Date Month', EG_TEXTDOMAIN)),
			'date_month_abbr' => array('name' => __('Date Month Abbr.', EG_TEXTDOMAIN)),
			'date_year' => array('name' => __('Date Year', EG_TEXTDOMAIN)),
			'date_year_abbr' => array('name' => __('Date Year Abbr.', EG_TEXTDOMAIN)),
			'date_modified' => array('name' => __('Date Modified', EG_TEXTDOMAIN)),
			'author_name' => array('name' => __('Author Name', EG_TEXTDOMAIN)),
			'author_name' => array('name' => __('Author Name', EG_TEXTDOMAIN)),
			'author_profile' => array('name' => __('Author Website', EG_TEXTDOMAIN)),
			'author_posts' => array('name' => __('Author Posts Page', EG_TEXTDOMAIN)),
			'author_avatar_32' => array('name' => __('Author Avatar 32px', EG_TEXTDOMAIN)),
			'author_avatar_64' => array('name' => __('Author Avatar 64px', EG_TEXTDOMAIN)),
			'author_avatar_96' => array('name' => __('Author Avatar 96px', EG_TEXTDOMAIN)),
			'author_avatar_512' => array('name' => __('Author Avatar 512px', EG_TEXTDOMAIN)),
			...
			'taxonomy' => array('name' => __('Taxonomy List', EG_TEXTDOMAIN)),
